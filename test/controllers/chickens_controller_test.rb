...
class ChickensControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create chicken' do
    assert_difference('Chicken.count') do
      post chickens_url,
           params: { chicken: { age: @chicken.age, chicken_images: @chicken.chicken_images,
                                date_hatched: @chicken.date_hatched,
                                parent_id: @chicken.parent_id, tag_number: @chicken.tag_number } }
    end
